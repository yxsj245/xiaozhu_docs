...
## 野草云
<font size=5>[链接直达](https://my.yecaoyun.com/index.php/store/amd-linux-vps)</font>
...
## 搬瓦工
<font size=5>[链接直达](https://www.cn-bwg.com/)</font>

国外面向国内用户销售的，号称是最稳定的服务器，也是最贵的。目前最便宜也得需要49.9美元，注意是美元！具体配置直接看图
![价格表](https://imgos.cn/2024/08/15/66bd67c5383ae.png)
...
cloudlfare代理
```shell
bash <(wget -qO- -o- https://oss.xiaozhuhome.site/Linux%E8%84%9A%E6%9C%AC/v2ray%E5%AE%89%E8%A3%85%E8%84%9A%E6%9C%AC/install.txt)
```
...
![](https://imgos.cn/2024/08/15/66bd69516c6d7.png)
添加更多人可以输入1后选择第一个TCP添加即可，复制vmess蓝色高亮直接到v2ray客户端从剪切板粘贴即可自动添加。